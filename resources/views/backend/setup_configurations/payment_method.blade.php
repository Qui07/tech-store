    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0 h6">{{translate('Momo')}}</h5>
                </div>
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('payment_method.update') }}" method="POST">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-4">
                                <label class="col-from-label">{{translate('MOMO_PARTNER_CODE')}}</label>
                            </div>
                            <div class="col-lg-8">
                                <input type="text" class="form-control" name="MOMO_PARTNER_CODE" value="{{  env('MOMO_PARTNER_CODE') }}" placeholder="{{ translate('PAYKU_BASE_URL') }}" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <input type="hidden" name="types[]" value="MOMO_ACCESS_KEY">
                            <div class="col-lg-4">
                                <label class="col-from-label">{{translate('MOMO_ACCESS_KEY')}}</label>
                            </div>
                            <div class="col-lg-8">
                                <input type="text" class="form-control" name="MOMO_ACCESS_KEY" value="{{  env('MOMO_ACCESS_KEY') }}" placeholder="{{ translate('PAYKU_PUBLIC_TOKEN') }}" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <input type="hidden" name="types[]" value="MOMO_SECRET_KEY">
                            <div class="col-lg-4">
                                <label class="col-from-label">{{translate('MOMO_SECRET_KEY')}}</label>
                            </div>
                            <div class="col-lg-8">
                                <input type="text" class="form-control" name="MOMO_SECRET_KEY" value="{{  env('MOMO_SECRET_KEY') }}" placeholder="{{ translate('PAYKU_PRIVATE_TOKEN') }}" required>
                            </div>
                        </div>
